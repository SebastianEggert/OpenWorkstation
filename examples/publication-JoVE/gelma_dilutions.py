...
equipment['pd1000'].aspirate(705.6, equipment['InputsC1'].wells('A3').bottom(9.8))
   # Dispense entire Out_Well_Vol into 1 Mixing Well
equipment['pd1000'].dispense(705.6, equipment['MixingD1'].wells('A4').bottom(4.8))
   # Loop 1.
   # Aspirate/Dispense Volume = 604.8
equipment['pd1000'].aspirate(604.8, equipment['InputsC1'].wells('A3').bottom(5.9))
   # Dispense entire Out_Well_Vol into 1 Mixing Well
equipment['pd1000'].dispense(604.8, equipment['MixingD1'].wells('B1').bottom(4.2))
   # Loop 2.
   # Aspirate/Dispense Volume = 468.0
equipment['pd1000'].aspirate(468.0, equipment['InputsC1'].wells('A3').bottom(2))
   # Dispense entire Out_Well_Vol into 1 Mixing Well
equipment['pd1000'].dispense(504.0, equipment['MixingD1'].wells('B2').bottom(2.0))
  # Loop 1.
   # Aspirate/Dispense Volume = 403.2
equipment['pd1000'].aspirate(403.2, equipment['InputsC1'].wells('A4').bottom(29.2))
   # Dispense entire Out_Well_Vol into 1 Mixing Well
equipment['pd1000'].dispense(403.2, equipment['MixingD1'].wells('B3').bottom(2.0))
   # Loop 1.
   # Aspirate/Dispense Volume = 302.4
equipment['pd1000'].aspirate(302.4, equipment['InputsC1'].wells('A4').bottom(27.2))
   # Dispense entire Out_Well_Vol into 1 Mixing Well
equipment['pd1000'].dispense(302.4, equipment['MixingD1'].wells('B4').bottom(2.0))
 # 2 = Dilent 1
...
equipment['pd1000'].dispense(201.6, equipment['MixingD1'].wells('A3').bottom(6.8))
   # Loop 1.
   # Aspirate/Dispense Volume = 302.4
equipment['pd1000'].aspirate(302.4, equipment['InputsC1'].wells('A1').bottom(28.2))
   # Dispense entire Out_Well_Vol into 1 Mixing Well
equipment['pd1000'].dispense(302.4, equipment['MixingD1'].wells('A4').bottom(6.8))
   # Loop 1.
   # Aspirate/Dispense Volume = 403.2
equipment['pd1000'].aspirate(403.2, equipment['InputsC1'].wells('A1').bottom(25.5))
   # Dispense entire Out_Well_Vol into 1 Mixing Well
equipment['pd1000'].dispense(403.2, equipment['MixingD1'].wells('B1').bottom(6.8))
   # Loop 1.
   # Aspirate/Dispense Volume = 504.0
equipment['pd1000'].aspirate(504.0, equipment['InputsC1'].wells('A1').bottom(22.3))
   # Dispense entire Out_Well_Vol into 1 Mixing Well
equipment['pd1000'].dispense(504.0, equipment['MixingD1'].wells('B2').bottom(6.8))
   # Loop 1.
   # Aspirate/Dispense Volume = 604.8
equipment['pd1000'].aspirate(604.8, equipment['InputsC1'].wells('A1').bottom(18.3))
   # Dispense entire Out_Well_Vol into 1 Mixing Well
equipment['pd1000'].dispense(604.8, equipment['MixingD1'].wells('B3').bottom(6.8))
   # Loop 1.
   # Aspirate/Dispense Volume = 705.6
equipment['pd1000'].aspirate(705.6, equipment['InputsC1'].wells('A1').bottom(13.7))
   # Dispense entire Out_Well_Vol into 1 Mixing Well
equipment['pd1000'].dispense(705.6, equipment['MixingD1'].wells('B4').bottom(6.8))
#RUN = Mixing
 # 7 = MIXTURE
# TRASH TIP
equipment['pd1000'].drop_tip()
