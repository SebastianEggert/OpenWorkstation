...
from openworkstation.drivers import connection
#from openworkstation.drivers.smoothie_drivers.v1_2_0.driver \
#    import SmoothieDriver_1_2_0
from openworkstation.drivers.smoothie_drivers.v2_0_0.driver \
    import SmoothieDriver_2_0_0
#from openworkstation.drivers.smoothie_drivers.v1_2_0.virtual_smoothie \
#    import VirtualSmoothie_1_2_0
from openworkstation.drivers.smoothie_drivers.v2_0_0.virtual_smoothie \
...
SMOOTHIE_DEFAULTS_DIR = pkg_resources.resource_filename(
    'openworkstation.config', 'smoothie')
